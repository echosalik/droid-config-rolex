# DisplayName: Jolla rolex/@ARCH@ (release) 1
...
repo --name=adaptation-community-common-rolex-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
@Jolla Configuration rolex
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/rolex
